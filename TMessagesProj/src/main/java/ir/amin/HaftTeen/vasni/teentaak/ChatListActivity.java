...
public  class ChatListActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, Callback<JsonObject> {
    ...
    private static RecyclerListView listView;
    private static AsymmetricGridView asymmetricGridView;
    private static DynamicViewAdapter asymetricGridAdapter;
    ...
    private static ActionBarMenuItem searchItem;
    ...
    public View createView(final Context context) {
        ...
        searchItem = menu.addItem(0, R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() {
            ...
            public void onSearchCollapse() {
                ...
                if (asymmetricGridView != null && listView != null) {
                    setVisibleDialogList(false);
                }
            }
        ...
        actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() {
            ...
            public void onItemClick(int id) {
                if (id == -1) {
                    ...
                    ChatListActivity dialogsActivity = new ChatListActivity(arguments);
        ...
        SizeNotifierFrameLayout contentView = new SizeNotifierFrameLayout(context) {
            ...
            protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                for (int i = 0; i < childCount; i++) {
                    ...
                    if (child == asymmetricGridView || child == listView || child == progressView || child == searchEmptyView) {
        ...
        scrollSlidingTextTabStrip.addTextTab(0, LocaleController.getString("matches", R.string.matches));
        scrollSlidingTextTabStrip.addTextTab(1, LocaleController.getString("chat", R.string.chat));*/
        ...
        if (phoneNumber.equals("") || phoneNumber == null) {
            ...
            ApiService.INSTANCE.getApiInterface().getPages(0).enqueue(ChatListActivity.this);
            getProfileInfo();
        }
            ...
            public void onPageSelected(int id, boolean forward) {
                switch (id) {
                    case 0:
                        ...
                        //presentFragment(new HomeFragment(context.getString(R.string.main_top_title), 0, ""));
//                        getQuestionAtServer();

           *//* dialogsAdapter = new DialogsAdapter(context, 0, onlySelect);
...
//                        cancelGetQuestionAtServer();
                        ...
                        break;
                    case 2:
                        // Toast.makeText(context, "Chanel", Toast.LENGTH_LONG).show();
                        floatingButton.setVisibility(View.VISIBLE);
                        listView.setAdapter(null);
                        dialogsAdapter = new DialogsAdapter(context, 2, onlySelect);
                        if (AndroidUtilities.isTablet() && openedDialogId != 0) {
                            dialogsAdapter.setOpenedDialogId(openedDialogId);
                        }
                        listView.setAdapter(dialogsAdapter);
...
//        contentView.addView(listView, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.MATCH_PARENT));
        ...
        listView.setOnItemClickListener((view, position) -> {
            ...
            if (adapter == dialogsAdapter) {
                ...
                if (object instanceof TLRPC.User) {
                    ...
                    if (invite.chat == null && (!invite.channel || invite.megagroup) || invite.chat != null && (!ChatObject.isChannel(invite.chat) || invite.chat.megagroup)) {
                        ...
                        showDialog(new JoinGroupAlert(getParentActivity(), invite, hash, ChatListActivity.this));
                        return;
                    } else {
                        if (invite.chat != null) {
                    ...
                    showDialog(new StickersAlert(getParentActivity(), ChatListActivity.this, set, null, null));
                    return;
            ...
            if (onlySelect) {
                ...
                if (searchString != null) {
                    if (MessagesController.getInstance(currentAccount).checkCanOpenChat(args, ChatListActivity.this)) {
...
//            listView.setAdapter(dialogsAdapter);
        ...
        if (!onlySelect && dialogsType == 0) {
            ...
            commentView.setDelegate(new ChatActivityEnterView.ChatActivityEnterViewDelegate() {
                ...
                public void onMessageSend(CharSequence message) {
                    ...
                    delegate.didSelectDialogs(ChatListActivity.this, selectedDialogs, message, false);
                }
    ...
    public static void setVisibleDialogList(boolean isShow) {
        if (listView == null || asymmetricGridView == null)
            return;
        if (isShow) {
...
//            }
    ...
    private void didSelectResult(final long dialog_id, boolean useAlert, final boolean param) {
        ...
        if (useAlert && (selectAlertString != null && selectAlertStringGroup != null || addToGroupAlertString != null)) {
            ...
            if (delegate != null) {
                ...
                dids.add(dialog_id);
                delegate.didSelectDialogs(ChatListActivity.this, dids, null, param);
                delegate = null;
            } else {
                finishFragment();
            }
            ...
            asymmetricGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    try {
                        ...
                        //presentFragment(newInstance(false));
        ...
        ApiService.INSTANCE.getApiInterface().getChannelInfo(id).enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                if (getSuccess(response.body()).getSuccess() == VasniSchema.Companion.getInstance().getSuccess()) {
                    ...
                    MessagesController.getInstance(currentAccount).openByBotName(getBotsArrayList.getData().get(0).getChannel_id(), ChatListActivity.this, 0);
                } else {
    ...
    private void getProfileInfo() {
        ApiService.INSTANCE.getApiInterface().getProfile().enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                if (getSuccess(response.body()).getSuccess() == VasniSchema.Companion.getInstance().getSuccess()) {
                    ResponseProfile profile = new Gson().fromJson(response.body(), ResponseProfile.class);
    ...
    public interface DialogsActivityDelegate {
        void didSelectDialogs(ChatListActivity fragment, ArrayList<Long> dids, CharSequence message, boolean param);
    }
}