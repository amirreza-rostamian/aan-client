...
public final class Id3Decoder implements MetadataDecoder {
    ...
    Id3Header decodeHeader(ParsableByteArray data) {
    ...
    private static @Nullable
    UrlLinkFrame decodeWxxxFrame(ParsableByteArray id3Data, int frameSize)
    ...
    private static @Nullable
    CommentFrame decodeCommentFrame(ParsableByteArray id3Data, int frameSize)
            throws UnsupportedEncodingException {
        if (frameSize < 4) {
            // Frame is malformed.
            return null;
