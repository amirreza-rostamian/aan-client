/*
This file is part of aan Desktop,
the official desktop version of aan messaging app, see https://aan.social

aan Desktop is free software: you can redistribute it and/or modify
...
Full license: https://github.com/aandesktop/tdesktop/blob/master/LICENSE
Copyright (c) 2014-2017 John Preston, https://desktop.aan.org
*/
...
jobjectArray
Java_ir_amin_HaftTeen_Emoji_getSuggestion(JNIEnv *env, jobject object, jstring query) {
    ...
    if (jclass_Suggestion == nullptr) {
        jclass_Suggestion = (jclass) env->NewGlobalRef(env->FindClass("ir/amin/HaftTeenmessenger/EmojiSuggestion"));
