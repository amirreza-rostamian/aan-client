...
public class AudioCell extends FrameLayout {
    ...
    public AudioCell(Context context) {
        ...
        titleTextView.setTypeface(ViewUtil.getFont(context));
        ...
        genreTextView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 11);
        genreTextView.setLines(1);
        genreTextView.setTypeface(ViewUtil.getFont(context));
        ...
        authorTextView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 11);
        authorTextView.setLines(1);
        authorTextView.setTypeface(ViewUtil.getFont(context));
        ...
        timeTextView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 10);
        timeTextView.setLines(1);
        timeTextView.setMaxLines(1);
        timeTextView.setTypeface(ViewUtil.getFont(context));
