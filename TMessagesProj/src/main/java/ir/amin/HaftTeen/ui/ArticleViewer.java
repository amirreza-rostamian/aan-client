...
import ir.amin.HaftTeen.ui.ActionBar.ActionBarPopupWindow;
...
import ir.amin.HaftTeen.ui.Components.Scroller;
import ir.amin.HaftTeen.ui.Components.SeekBar;
import ir.amin.HaftTeen.ui.Components.ShareAlert;
import ir.amin.HaftTeen.ui.Components.TextPaintSpan;
import ir.amin.HaftTeen.ui.Components.TextPaintUrlSpan;
import ir.amin.HaftTeen.ui.Components.TypefaceSpan;
import ir.amin.HaftTeen.ui.Components.VideoPlayer;
import ir.amin.HaftTeen.ui.Components.WebPlayerView;
            ...
            if (previousBlock != currentBlock) {
                ...
                try {
                    if (currentBlock.html != null) {
                        webView.loadDataWithBaseURL("https://aan.social/embed", currentBlock.html, "text/html", "UTF-8", null);
                        videoView.setVisibility(INVISIBLE);
                        videoView.loadVideo(null, null, null, false);
                        webView.setVisibility(VISIBLE);
                    } else {
