...
import ir.amin.HaftTeen.ui.CacheControlActivity;
import ir.amin.HaftTeen.ui.Cells.AccountSelectCell;
import ir.amin.HaftTeen.ui.Cells.RadioColorCell;
import ir.amin.HaftTeen.ui.Cells.TextColorCell;
import ir.amin.HaftTeen.ui.LaunchActivity;
import ir.amin.HaftTeen.ui.ProfileNotificationsActivity;
import ir.amin.HaftTeen.ui.ReportOtherActivity;
...
public class AlertsCreator {
    ...
    public static AlertDialog showSecretLocationAlert(Context context, int currentAccount, final Runnable onSelectRunnable, boolean inChat) {
        ...
        if ((providers & 1) != 0) {
            arrayList.add(LocaleController.getString("MapPreviewProvideraan", R.string.MapPreviewProvideraan));
        }
        if ((providers & 2) != 0) {
