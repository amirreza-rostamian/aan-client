...
class MoreVideoEpisodeFragment : BaseFragment, NotificationCenter.NotificationCenterDelegate, Callback<JsonObject> {

    private var txt: String = ""
    private var videoId: String = ""
    private val adapter = MoreAdapter()
    private var videoCategory = VideoCategory()
...
//        videoCategory = DataLoader.instance.videoCategory
        initView()
    ...
    fun initView() {
        ...
        ApiService.apiInterface.getVitrinVideoEpisodes(videoId).enqueue(this)
