...
import ir.amin.HaftTeen.ui.Components.FireworksEffect;
import ir.amin.HaftTeen.ui.Components.LayoutHelper;
import ir.amin.HaftTeen.ui.Components.SnowflakesEffect;
...
public class ActionBar extends FrameLayout {
    ...
    private void createBackButtonImage() {
        ...
        backButtonImageView.setId(R.id.back_button);
    ...
    private void createTitleTextView() {
        ...
        titleTextView.setTypeface(ViewUtil.getFont(getContext()));
        titleTextView.setTextSize(AndroidUtilities.dp(9));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (titleTextView != null && titleTextView.getVisibility() != GONE || subtitleTextView != null && subtitleTextView.getVisibility() != GONE) {
            ...
            if (titleTextView != null && titleTextView.getVisibility() != GONE) {
                titleTextView.setTextSize(!AndroidUtilities.isTablet() && getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE ? 18 : 16);
