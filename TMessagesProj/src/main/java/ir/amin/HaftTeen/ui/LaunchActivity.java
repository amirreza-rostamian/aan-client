...
import ir.amin.HaftTeen.messenger.camera.CameraController;
import ir.amin.HaftTeen.messenger.support.widget.DefaultItemAnimator;
...
import ir.amin.HaftTeen.ui.ActionBar.DrawerLayoutContainer;
import ir.amin.HaftTeen.ui.ActionBar.Theme;
import ir.amin.HaftTeen.ui.Adapters.DrawerLayoutAdapter;
...
import ir.amin.HaftTeen.ui.Components.AudioPlayerAlert;
import ir.amin.HaftTeen.ui.Components.BlockingUpdateView;
...
import ir.amin.HaftTeen.ui.Components.PasscodeView;
import ir.amin.HaftTeen.ui.Components.PipRoundVideoView;
import ir.amin.HaftTeen.ui.Components.RecyclerListView;
import ir.amin.HaftTeen.ui.Components.SharingLocationsAlert;
import ir.amin.HaftTeen.ui.Components.StickersAlert;
import ir.amin.HaftTeen.ui.Components.TermsOfServiceView;
import ir.amin.HaftTeen.ui.Components.ThemeEditorView;
import ir.amin.HaftTeen.ui.Components.UpdateAppAlertDialog;
...
public class LaunchActivity extends Activity implements ActionBarLayout.ActionBarLayoutDelegate, NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate {
    ...
    public static FragmentManager getFragmenrManager() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentManager = getFragmenrManager();
        ...
        sideMenu.setOnItemClickListener((view, position) -> {
            if (position == 0) {
                ...
                if (id == 2) {
                    ...
                    Browser.openUrl(LaunchActivity.this, LocaleController.getString("aanFaqUrl", R.string.aanFaqUrl));
                    drawerLayoutContainer.closeDrawer(false);
                } else if (id == 10) {
        ...
        if (!fromPassword && (AndroidUtilities.needShowPasscode(true) || SharedConfig.isWaitingForPasscodeEnter)) {
            ...
            if (UserConfig.getInstance(currentAccount).isClientActivated() && (flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
                if (intent != null && intent.getAction() != null && !restore) {
                        ...
                        if (data != null) {
                            ...
                            if (scheme != null) {
                                if ((scheme.equals("http") || scheme.equals("https"))) {
                                    ...
                                    if (host.equals("aan.me") || host.equals("t.me") || host.equals("aan.dog") || host.equals("telesco.pe") /* fixme: inapp-browser || "stage.wavecom.io".equals(host) */) {
                                    ...
                                    if (url.startsWith("tg:resolve") || url.startsWith("tg://resolve")) {
                                        url = url.replace("tg:resolve", "tg://aan.org").replace("tg://resolve", "tg://aan.org");
                                        data = Uri.parse(url);
                                        username = data.getQueryParameter("domain");
                                        if ("aanpassport".equals(username)) {
                                            username = null;
                                            auth = new HashMap<>();
                                        ...
                                        url = url.replace("tg:join", "tg://aan.org").replace("tg://join", "tg://aan.org");
                                        data = Uri.parse(url);
                                        group = data.getQueryParameter("invite");
                                    } else if (url.startsWith("tg:addstickers") || url.startsWith("tg://addstickers")) {
                                        url = url.replace("tg:addstickers", "tg://aan.org").replace("tg://addstickers", "tg://aan.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:msg", "tg://aan.org").replace("tg://msg", "tg://aan.org").replace("tg://share", "tg://aan.org").replace("tg:share", "tg://aan.org");
                                        data = Uri.parse(url);
                                        message = data.getQueryParameter("url");
                                        if (message == null) {
                                            message = "";
                                        ...
                                        url = url.replace("tg:confirmphone", "tg://aan.org").replace("tg://confirmphone", "tg://aan.org");
                                        data = Uri.parse(url);

                                        phone = data.getQueryParameter("phone");
                                        phoneHash = data.getQueryParameter("hash");
                                    } else if (url.startsWith("tg:openmessage") || url.startsWith("tg://openmessage")) {
                                        url = url.replace("tg:openmessage", "tg://aan.org").replace("tg://openmessage", "tg://aan.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:passport", "tg://aan.org").replace("tg://passport", "tg://aan.org").replace("tg:secureid", "tg://aan.org");
                                        data = Uri.parse(url);
                                        auth = new HashMap<>();
                                        String scope = data.getQueryParameter("scope");
                                        if (!TextUtils.isEmpty(scope) && scope.startsWith("{") && scope.endsWith("}")) {
                    ...
                    } else if (intent.getAction().equals("ir.amin.HaftTeen.messenger.OPEN_ACCOUNT")) {
                        open_settings = 1;
                    ...
                    if (visibleDialog != null) {
                        if (visibleDialog == localeDialog) {
                            try {
                                ...
                                Toast.makeText(LaunchActivity.this, getStringForLanguageAlert(shorname.equals("fa") ? englishLocaleStrings : systemLocaleStrings, "ChangeLanguageLater", R.string.ChangeLanguageLater), Toast.LENGTH_LONG).show();
                            } catch (Exception e) {
                                FileLog.e(e);
                            }
                            localeDialog = null;
    ...
    public void didReceivedNotification(int id, final int account, Object... args) {
        if (id == NotificationCenter.appDidLogout) {
            ...
            if (reason == 0) {
                ...
                builder.setMessage(LocaleController.getString("UseProxyaanError", R.string.UseProxyaanError));
                builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), null);
