...
import ir.amin.HaftTeen.messenger.KeepAliveJob;
...
//        });
    ...
    /* BUG ->
     * DNS resolution code below is one ugly workaround DNS lockout mechanic
     *
     * The only reference is AAN/TMessagesProj/jni/TgNetWrapper.cpp:497
     * Good news everyone! We don't need that bloated shit
     * One more good news everyone! No need to patch any mm code!
     * Because of not being Java Expert myself still Googled it for you
     * in case of you are gonna be another one of future me
     *
        ...
        protected NativeByteBuffer doInBackground(Void... voids) {
            ...
            for (int i = 0; i < 3; i++) {
                try {
                     ...
                     * as long as we resolve dcDomainName to address in form of long number we gonna be fine

                     * public static native void native_applyDnsConfig(int currentAccount, long address, String phone);*/

/* LOOKS LIKE START OF SHITCODE----->>>
