...
public class DrawerLayoutAdapter extends RecyclerListView.SelectionAdapter {
    ...
    private void resetItems() {
        ...
        items.add(new Item(2, LocaleController.getString("NewGroup", R.string.NewGroup), R.drawable.menu_newgroup, R.id.create_new_group));
//        items.add(new Item(3, LocaleController.getString("NewSecretChat", R.string.NewSecretChat), R.drawable.menu_secret));
        items.add(new Item(4, LocaleController.getString("NewChannel", R.string.NewChannel), R.drawable.menu_broadcast, R.id.create_new_channel));
        items.add(null); // divider
        items.add(new Item(6, LocaleController.getString("Contacts", R.string.Contacts), R.drawable.menu_contacts, R.id.contacts_list));
        items.add(new Item(11, LocaleController.getString("SavedMessages", R.string.SavedMessages), R.drawable.menu_saved, R.id.saved_messages));
//        items.add(new Item(10, LocaleController.getString("Calls", R.string.Calls), R.drawable.menu_calls)); // [todo - calling by Niko]
        items.add(new Item(7, LocaleController.getString("InviteFriends", R.string.InviteFriends), R.drawable.menu_invite, R.id.invite_friends));
        items.add(new Item(8, LocaleController.getString("Settings", R.string.Settings), R.drawable.menu_settings, R.id.menu_settings));
//        items.add(new Item(9, LocaleController.getString("aanFAQ", R.string.aanFAQ), R.drawable.menu_help));
    }
    ...
    private class Item {
        ...
        public Item(int id, String text, int icon, int viewId) {
            this.icon = icon;
            this.id = id;
            this.text = text;
            this.viewId = viewId;
