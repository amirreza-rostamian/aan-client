...
import ir.amin.HaftTeen.ui.Cells.PaymentInfoCell;
import ir.amin.HaftTeen.ui.Cells.RadioCell;
...
import ir.amin.HaftTeen.ui.Cells.TextPriceCell;
        ...
        if (currentStep == 0) {
            ...
            if (isWebView) {
                ...
                if (Build.VERSION.SDK_INT >= 17) {
                    webView.addJavascriptInterface(new aanWebviewProxy(), "aanWebviewProxy");
                }
