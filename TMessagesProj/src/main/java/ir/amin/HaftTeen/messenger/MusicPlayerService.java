...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "ir.amin.HaftTeen.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "ir.amin.HaftTeen.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "ir.amin.HaftTeen.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "ir.amin.HaftTeen.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "ir.amin.HaftTeen.android.musicplayer.next";
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mediaSession = new MediaSession(this, "aanAudioPlayer");
