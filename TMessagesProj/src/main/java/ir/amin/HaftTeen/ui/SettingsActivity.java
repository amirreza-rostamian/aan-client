...
import ir.amin.HaftTeen.ui.Cells.EmptyCell;
import ir.amin.HaftTeen.ui.Cells.HeaderCell;
import ir.amin.HaftTeen.ui.Cells.ShadowSectionCell;
import ir.amin.HaftTeen.ui.Cells.TextCheckCell;
import ir.amin.HaftTeen.ui.Cells.TextDetailSettingsCell;
import ir.amin.HaftTeen.ui.Cells.TextInfoCell;
import ir.amin.HaftTeen.ui.Cells.TextSettingsCell;
...
import ir.amin.HaftTeen.ui.Components.ImageUpdater;
import ir.amin.HaftTeen.ui.Components.LayoutHelper;
import ir.amin.HaftTeen.ui.Components.NumberPicker;
...
//    private int usernameRow;
    ...
    private int settingsBlankRow;
    private int settingsSectionRow2;
    //    private int enableAnimationsRow;
//    private int securitySectionRow;
//    private int securitySectionRow2;
//    private int passcodeRow;
//    private int twostepVerificationRow;
...
//        securitySectionRow2 = rowCount++;
//        passcodeRow = rowCount++;
//        twostepVerificationRow = rowCount++;
...
//                    presentFragment(new DataSettingsActivity());
                    ...
                    builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
                    showDialog(builder.create());
                } else if (position == aanFaqRow) {
                    Browser.openUrl(getParentActivity(), LocaleController.getString("aanFaqUrl", R.string.aanFaqUrl));
...
//                    }
                ...
                case 2: {
                    ...
                    if (position == textSizeRow) {
                        SharedPreferences preferences = MessagesController.getGlobalMainSettings();
                        int size = preferences.getInt("fons_size", AndroidUtilities.isTablet() ? 18 : 12);
...
//                    }
//                    else if (position == privacyRow) {
//                        textCell.setTextAndIcon(LocaleController.getString("Passcode", R.string.Passcode), R.drawable.menu_secret, true);
//                    }
//                    else if (position == passcodeRow) {
//                        textCell.setTextAndIcon(LocaleController.getString("Passcode", R.string.Passcode), R.drawable.menu_secret, true);
//                    } else if (position == twostepVerificationRow) {
...
//                        textCell.setText(LocaleController.getString("DataSettings", R.string.DataSettings), true);
                        ...
                        textCell.setText(LocaleController.getString("aanFAQ", R.string.aanFAQ), true);
                    } else if (position == contactsReimportRow) {
...
//                    } else
                ...
                case 4: {
                    ...
                    } else if (position == settingsBlankRow) {
                        ((HeaderCell) holder.itemView).setText("");
                    }
//                    else if (position == securitySectionRow2) {
//                        ((HeaderCell) holder.itemView).setText(LocaleController.getString("SecuritySettings", R.string.SecuritySettings));
//                    }
                    break;
                }
                case 6: {
                    ...
                    if (position == bioRow) {
                        ...
                        if (userInfo == null || !TextUtils.isEmpty(userInfo.about)) {
                            ...
                            textCell.setTextAndValue(LocaleController.getString("UserBio", R.string.UserBio), LocaleController.getString("UserBio", R.string.UserBio), false);
                        }
                    }
                }
            }
        ...
        public boolean isEnabled(RecyclerView.ViewHolder holder) {
            ...
            return position == textSizeRow || position == notificationRow || position == backgroundRow ||
                    position == sendLogsRow || position == sendByEnterRow || position == autoplayGifsRow || /*position == passcodeRow || position == twostepVerificationRow || */
                    position == clearLogsRow || position == languageRow || position == switchBackendButtonRow || position == aanFaqRow ||
                    position == contactsSortRow || position == contactsReimportRow || position == saveToGalleryRow ||
                    ...
                    position == emojiRow || position == dataRow || position == themeRow || position == privacyRow || position == bioRow;
        }
            ...
            switch (viewType) {
                ...
                case 5:
                    ...
                    try {
                        ...
                        ((TextInfoCell) view).setText("HaftTeen for Android v1.0");
                    } catch (Exception e) {
                        FileLog.e(e);
                    }
                    break;
        ...
        public int getItemViewType(int position) {
            ...
            if (position == supportSectionRow || position == messagesSectionRow || position == contactsSectionRow) {
                return 1;
            } else if (position == sendByEnterRow || position == saveToGalleryRow || position == autoplayGifsRow || position == raiseToSpeakRow || position == customTabsRow || position == directShareRow) {
                return 3;
            } else if (position == notificationRow || position == themeRow || position == backgroundRow || position == sendLogsRow || position == clearLogsRow || position == switchBackendButtonRow || position == aanFaqRow || position == contactsReimportRow || position == textSizeRow || position == contactsSortRow || position == stickersRow || position == privacyPolicyRow || position == emojiRow || position == dataRow /*|| position == passcodeRow || position == twostepVerificationRow*/ || position == privacyRow) {
                return 2;
            } else if (position == versionRow) {
                return 5;
            } else if (position == settingsBlankRow || position == settingsSectionRow2 || position == messagesSectionRow2 || position == supportSectionRow2) {
                return 4;
            } else if (position == bioRow) {
                return 6;
            } else {
