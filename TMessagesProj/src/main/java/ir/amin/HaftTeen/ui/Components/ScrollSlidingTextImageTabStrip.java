...
public class ScrollSlidingTextImageTabStrip extends HorizontalScrollView {
    ...
    public void addTextTab(final int id, CharSequence text, Drawable drawable) {
...
//        });
        ...
        txtContainer.addView(tab, LayoutHelper.createRelative(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT,0,0,0,2, RelativeLayout.ALIGN_PARENT_BOTTOM));

        AppCompatImageView imageView = new AppCompatImageView(getContext());
        imageView.setImageDrawable(drawable);
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        txtContainer.addView(imageView, LayoutHelper.createRelative(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT, RelativeLayout.ALIGN_PARENT_TOP , RelativeLayout.CENTER_IN_PARENT));
