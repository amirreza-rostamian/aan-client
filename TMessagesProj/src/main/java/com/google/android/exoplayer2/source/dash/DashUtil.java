...
public final class DashUtil {
    ...
    ChunkExtractorWrapper loadInitializationData(
    ...
    private static @Nullable
    Representation getFirstRepresentation(Period period, int type) {
