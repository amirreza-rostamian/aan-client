...
import ir.amin.HaftTeen.messenger.SRPHelper;
...
import ir.amin.HaftTeen.tgnet.SerializedData;
...
import ir.amin.HaftTeen.ui.Components.EditTextBoldCursor;
import ir.amin.HaftTeen.ui.Components.HintEditText;
import ir.amin.HaftTeen.ui.Components.LayoutHelper;
import ir.amin.HaftTeen.ui.Components.SlideView;
...
import ir.amin.HaftTeen.vasni.webservice.LoginUser;
import ir.amin.HaftTeen.vasni.webservice.RegisterWebService;
import ir.amin.HaftTeen.R;

@SuppressLint("HardwareIds")
public class LoginActivity extends BaseFragment {

    private final static int done_button = R.id.done_button;
    ...
    public View createView(Context context) {
        ...
        fragmentView.setId(R.id.container);
    ...
    private void onAuthSuccess(TLRPC.TL_auth_authorization res) {
        ...
        needFinishActivity();
//        isNewRecord = MSharePk.getBoolean(getParentActivity(), AppSchema.isNewRecord, false);
//        if (isNewRecord) {
//            RegisterWebService registerWebService = new RegisterWebService(new RegisterWebService.OnResponse() {
//                @Override
//                public void onSuccess(ResponseRegister register) {
//                    Function.setUserId(getParentActivity(), "" + register.getData().getId());
//                   /* AdpPushClient client = AdpPushClient.get();
//                    client.register(Function.md5("aanUserId" + register.getData().getId()));
//                    JSONObject data = new JSONObject();
//                    try {
//                        data.put("register_sucsses", "euxbl");
//                    } catch (JSONException e) {
//                        e.printStackTrace();
//                    }
//                    AdpPushClient.get().track("Register", data);*/
//                    needFinishActivity();
//                }
//
//                @Override
...
//                    /*JSONObject data = new JSONObject();
//                    try {
//                        data.put("register_error", "hcolx");
//                    } catch (JSONException e) {
//                        e.printStackTrace();
//                    }
//                    AdpPushClient.get().track("Failed Register", data);*/
//
//                }
//            });
//            RequestBody name = RequestBody.create(MultipartBody.FORM, users.get(0).first_name + users.get(0).last_name);
//            RequestBody mobile = RequestBody.create(MultipartBody.FORM, users.get(0).phone);
//            registerWebService.registerUser(name, mobile);
//        } else {
//            needFinishActivity();
//        }
...
//                LoginUser loginUser = new LoginUser(new LoginUser.OnResponse() {
//                    @Override
//                    public void onSuccess(ResponseLoginData data) {
//                        MSharePk.putBoolean(getParentActivity(), AppSchema.isNewRecord, data.getIsNewRecord());
//                        MSharePk.putString(getParentActivity(), AppSchema.token, data.getToken());
//                        params.putInt("type", 2);
//                        params.putInt("length", res.type.length);
//                        setPage(2, true, params, false);
//                    }
...
//                loginUser.loginUser();
    ...
    public class PhoneView extends SlideView implements AdapterView.OnItemSelectedListener {
        ...
        public PhoneView(Context context) {
            ...
            countryButton.setId(R.id.select_country);
            ...
            codeField.setId(R.id.code_field);
            ...
            phoneField.setId(R.id.phone_number_field);
            ...
            if (newAccount) {
                ...
                checkBoxCell.setId(R.id.sync_contacts);
...
//                            getParentActivity().requestPermissions(permissionsItems.toArray(new String[permissionsItems.size()]), 6);
//                        } else
                        if (preferences.getBoolean("firstlogin", true) || getParentActivity().shouldShowRequestPermissionRationale(Manifest.permission.RECEIVE_SMS)) {
...
//                            permissionsDialog = showDialog(builder.create());
            ...
            MSharePk.putString(getParentActivity(), AppSchema.phoneNumber, phone);
...
//                            }
                            ...
                            if (!permissionsShowItems.isEmpty()) {
                                SharedPreferences preferences = MessagesController.getGlobalMainSettings();
                                if (preferences.getBoolean("firstloginshow", true) || getParentActivity().shouldShowRequestPermissionRationale(Manifest.permission.RECEIVE_SMS)) {
    ...
    public class LoginActivitySmsView extends SlideView implements NotificationCenter.NotificationCenterDelegate {
        ...
        public LoginActivitySmsView(Context context, final int type) {
            ...
            if (currentType == 3) {
                ...
                progressView.setId(R.id.progress_bar);
                timeText.setGravity(LocaleController.isRTL ? Gravity.RIGHT : Gravity.LEFT);
            ...
            problemText.setId(R.id.code_not_came);
            ...
            wrongNumber.setId(R.id.wrong_number);
        ...
        public void setParams(Bundle params, boolean restore) {
            ...
            } else if (currentType == 2 && (nextType == 4 || nextType == 3 || nextType == 2)) {
                timeText.setVisibility(VISIBLE);
                if (nextType == 2) {
                    timeText.setText(LocaleController.formatString("ResendSmsText", R.string.ResendSmsText, 1, 0));
                } else {
                    timeText.setText(
                    ...
                    AndroidUtilities.runOnUIThread(() -> {
                        if (time >= 1000) {
                            ...
                            if (nextType == 4 || nextType == 3) {
                                ...
                                timeText.setText(LocaleController.formatString("ResendSmsText", R.string.ResendSmsText, minutes, seconds));
                            }
                            if (progressView != null) {
                            ...
                            if (currentType == 3) {
                                ...
                                if (nextType == 4) {
                                    ...
                                    final SpannableString resendText = new SpannableString("Resend SMS");
                                    resendText.setSpan(new ForegroundColorSpan(Theme.getColor(Theme.key_windowBackgroundWhiteBlueText4)),
                                            0, resendText.length(), 0);
                                    timeText.setText(resendText);
                                    destroyCodeTimer();
                                }
                            }
                        }
...
//            destroyTimer();
    ...
    public class LoginActivityPasswordView extends SlideView {
        ...
        public LoginActivityPasswordView(Context context) {
            ...
            cancelButton.setId(R.id.cancel);
            ...
            resetAccountButton.setId(R.id.reset_account);
    ...
    public class LoginActivityResetWaitView extends SlideView {
        ...
        public LoginActivityResetWaitView(Context context) {
            ...
            resetAccountTime.setId(R.id.reset_account_time);
            ...
            resetAccountButton = new TextView(context);
            resetAccountButton.setText(R.id.reset_account);
            resetAccountButton.setGravity((LocaleController.isRTL ? Gravity.RIGHT : Gravity.LEFT) | Gravity.TOP);
    ...
    public class LoginActivityRegisterView extends SlideView {
        ...
        public LoginActivityRegisterView(Context context) {
            ...
            firstNameField.setId(R.id.first_name);
            ...
            lastNameField.setId(R.id.last_name);
