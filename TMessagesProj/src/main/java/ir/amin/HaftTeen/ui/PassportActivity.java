...
import ir.amin.HaftTeen.messenger.MrzRecognizer;
...
import ir.amin.HaftTeen.messenger.SecureDocumentKey;
...
import ir.amin.HaftTeen.ui.Cells.TextInfoPrivacyCell;
...
import ir.amin.HaftTeen.ui.Components.ContextProgressView;
...
import ir.amin.HaftTeen.ui.Components.RadialProgress;
...
public class PassportActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void createPasswordInterface(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("aanPassport", R.string.aanPassport));
        ...
        noPasswordTextView.setText(LocaleController.getString("aanPassportCreatePasswordInfo", R.string.aanPassportCreatePasswordInfo));
        ...
        noPasswordSetTextView.setText(LocaleController.getString("aanPassportCreatePassword", R.string.aanPassportCreatePassword));
        ...
        passwordForgotButton.setOnClickListener(v -> {
            if (currentPassword.has_recovery) {
                ...
                builder.setNegativeButton(LocaleController.getString("RestorePasswordResetAccount", R.string.RestorePasswordResetAccount), (dialog, which) -> Browser.openUrl(getParentActivity(), "https://aan.social/deactivate?phone=" + UserConfig.getInstance(currentAccount).getClientPhone()));
    ...
    private void createManageInterface(Context context) {
        ...
        deletePassportCell.setText(LocaleController.getString("aanPassportDelete", R.string.aanPassportDelete), false);
        ...
        deletePassportCell.setOnClickListener(v -> {
            ...
            builder.setTitle(LocaleController.getString("AppName", R.string.AppName));
            builder.setMessage(LocaleController.getString("aanPassportDeleteAlert", R.string.aanPassportDeleteAlert));
            showDialog(builder.create());
        });
