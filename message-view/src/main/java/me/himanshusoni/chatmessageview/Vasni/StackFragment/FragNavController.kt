...
import me.himanshusoni.chatmessageview.Vasni.StackFragment.tabhistory.*
    ...
    var navigationStrategy: NavigationStrategy = CurrentTabStrategy()
        set(value) {
            ...
            fragNavTabHistoryController = when (value) {
                ...
                is UnlimitedTabHistoryStrategy -> {
                    UnlimitedTabHistoryController(DefaultFragNavPopController(), value.fragNavSwitchController)
                }
