...
public class CircularCountDownBar extends View {
    ...
    private int mPaintBackGroundColor = Color.parseColor("#00ff0000");//初始值
    ...
    public CircularCountDownBar(Context context) {
        this(context, null);
    }

    public CircularCountDownBar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircularCountDownBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        mPaintText.setTypeface(Typeface.createFromAsset(mContext.getAssets(), "fonts/sh_bold.ttf"));
