...
public class AnalyticsCollector
    ...
    private static final class MediaPeriodQueueTracker {
         ...
         */
        public @Nullable
        WindowAndMediaPeriodId getPlayingMediaPeriod() {
         ...
         */
        public @Nullable
        WindowAndMediaPeriodId getLastReportedPlayingMediaPeriod() {
         ...
         */
        public @Nullable
        WindowAndMediaPeriodId getReadingMediaPeriod() {
         ...
         */
        public @Nullable
        WindowAndMediaPeriodId getLoadingMediaPeriod() {
         ...
         */
        public @Nullable
        MediaPeriodId tryResolveWindowIndex(int windowIndex) {
