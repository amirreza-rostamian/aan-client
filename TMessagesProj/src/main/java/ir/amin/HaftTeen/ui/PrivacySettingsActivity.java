...
//        secretDetailRow = rowCount++;
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public boolean isEnabled(RecyclerView.ViewHolder holder) {
            ...
            return position == passcodeRow || position == passwordRow || position == contactsSyncRow || position == sessionsRow; /* || position == blockedRow  || position == secretWebpageRow || position == webSessionsRow || position == clearDraftsRow ||*/
...
//                    } else if (position == passportRow) {
//                        textCell.setText(LocaleController.getString("aanPassport", R.string.aanPassport), true);
//                    } else if (position == callsRow) {
//                        String value;
...
//                            case 0:
//                                value = LocaleController.getString("MapPreviewProvideraan", R.string.MapPreviewProvideraan);
//                                break;
//                            case 1:
...
//                    }
        ...
        public int getItemViewType(int position) {
            if (position == passwordRow || position == passcodeRow || position == sessionsRow) {
                return 0;
            } else if (position == sessionsDetailRow) {
                return 1;
            } else if (position == securitySectionRow || position == contactsSectionRow) {
                return 2;
            } else if (position == contactsSyncRow) {
                return 3;
            }
//            if (position == passportRow || position == lastSeenRow || position == blockedRow || position == deleteAccountRow  || position == webSessionsRow || position == passwordRow || position == passcodeRow || position == groupsRow || position == paymentsClearRow || position == callsP2PRow || position == secretMapRow || position == contactsDeleteRow || position == clearDraftsRow) {
//                return 0;
//            } else if (position == deleteAccountDetailRow || position == groupsDetailRow || position == secretDetailRow || position == botsDetailRow || position == callsDetailRow || position == contactsDetailRow) {
//                return 1;
