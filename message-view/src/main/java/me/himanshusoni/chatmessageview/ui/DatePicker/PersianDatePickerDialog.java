...
public class PersianDatePickerDialog {
    ...
    public PersianDatePickerDialog(Context context) {
        ...
        typeFace = Typeface.createFromAsset(this.context.getAssets(), "fonts/sh_normal.ttf");
    }
    ...
    public void show() {
        ...
        datePicker.setDividerColor(context.getResources().getColor(R.color.divider_date_picker));
