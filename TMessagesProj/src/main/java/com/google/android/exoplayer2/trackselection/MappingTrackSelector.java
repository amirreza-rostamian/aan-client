...
public abstract class MappingTrackSelector extends TrackSelector {
    ...
    MappedTrackInfo getCurrentMappedTrackInfo() {
    ...
    public static final class MappedTrackInfo {
        ...
        int getRendererSupport(int rendererIndex) {
        ...
        @Deprecated
        public @RendererSupport
        int getTrackTypeRendererSupport(int trackType) {
         ...
         */
        public @RendererSupport
        int getTypeSupport(int trackType) {
            int bestRendererSupport = RENDERER_SUPPORT_NO_TRACKS;
