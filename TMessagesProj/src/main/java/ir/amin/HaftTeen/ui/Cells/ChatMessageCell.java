...
import ir.amin.HaftTeen.ui.Components.LinkPath;
import ir.amin.HaftTeen.ui.Components.RadialProgress;
import ir.amin.HaftTeen.ui.Components.RoundVideoPlayingDrawable;
import ir.amin.HaftTeen.ui.Components.SeekBar;
import ir.amin.HaftTeen.ui.Components.SeekBarWaveform;
import ir.amin.HaftTeen.ui.Components.StaticLayoutEx;
...
import ir.amin.HaftTeen.ui.PhotoViewer;
import ir.amin.HaftTeen.ui.SecretMediaViewer;
    ...
    public void setMessageObject(MessageObject messageObject, MessageObject.GroupedMessages groupedMessages, boolean bottomNear, boolean topNear) {
        ...
        if (messageChanged || dataChanged || groupChanged || isPhotoDataChanged(messageObject) || pinnedBottom != bottomNear || pinnedTop != topNear) {
            ...
            if (messageObject.type == 0) {
                ...
                if (!drawInstantView) {
                    if ("aan_channel".equals(webpageType)) {
                        drawInstantView = true;
                        drawInstantViewType = 1;
                    } else if ("aan_megagroup".equals(webpageType)) {
                        drawInstantView = true;
                        drawInstantViewType = 2;
                    } else if ("aan_message".equals(webpageType)) {
                        drawInstantView = true;
                        drawInstantViewType = 3;
                    } /*else if ("aan_proxy".equals(webpageType)) {
                        drawInstantView = true;
                        drawInstantViewType = 4;
                    }*/
                } else if (siteName != null) {
                    siteName = siteName.toLowerCase();
                    if ((siteName.equals("instagram") || siteName.equals("twitter") || "aan_album".equals(webpageType)) && messageObject.messageOwner.media.webpage.cached_page instanceof TLRPC.TL_pageFull &&
        ...
        if (currentMessageObject.isOutOwner()) {
            ...
            if (currentMessageObject.isSending() || currentMessageObject.isEditing()) {
                ...
                if (!currentMessageObject.isUnread()) {
                    drawCheck1 = false; // todo: revert to show read status
                    drawCheck2 = true;
                } else {
                    drawCheck1 = false;
                    drawCheck2 = true;
