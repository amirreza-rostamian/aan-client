...
public class SharedConfig {
    ...
    public static void loadConfig() {
        synchronized (sync) {
            ...
            fontSize = preferences.getInt("fons_size", AndroidUtilities.isTablet() ? 18 : 12);
    ...
    public static void checkSaveToGalleryFiles() {
        try {
            File aanPath = new File(Environment.getExternalStorageDirectory(), VasniSchema.Companion.getInstance().getAppicationName());
