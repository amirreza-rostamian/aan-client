            ...
            public void run() {
                ...
                Utilities.stageQueue.postRunnable(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String loc_key = null;
                        try {
                            JSONObject json = new JSONObject(String.valueOf(data.get("p")));
                            System.out.println("GCM.json: " + json);
                            ...
                            if (dialog_id != 0) {
                                ...
                                if (badge != 0) {
                                    ...
                                    if (processNotification) {
                                        ...
                                        System.out.println("GCM received message notification " + loc_key + " for dialogId = " + dialog_id + " mid = " + msg_id);
                                        switch (loc_key) {
                                            case "MESSAGE_TEXT": {
