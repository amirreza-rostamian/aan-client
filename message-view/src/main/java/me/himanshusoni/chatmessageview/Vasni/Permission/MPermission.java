...
public class MPermission {
    ...
    public static MPermission create(Context context) {
        return new MPermission(context);
    }
    ...
    public MPermission title(String title) {
        mTitle = title;
        return this;
    }

    public MPermission msg(String msg) {
        mMsg = msg;
        return this;
    }

    public MPermission permissions(List<PermissionItem> permissionItems) {
        mCheckPermissions = permissionItems;
        return this;
    }

    public MPermission filterColor(int color) {
        mFilterColor = color;
        return this;
    }

    public MPermission animStyle(int styleId) {
        mAnimStyleId = styleId;
        return this;
    }

    public MPermission style(int styleResIdsId) {
