...
class BottomDialog protected constructor(val builder: Builder?) {
    ...
    private fun initBottomDialog(builder: Builder): Dialog {
        ...
        iconImageView = view.findViewById(R.id.bottomDialog_icon)
        titleTextView = view.findViewById(R.id.bottomDialog_title)
        contentTextView = view.findViewById(R.id.bottomDialog_content)
        vCustomView = view.findViewById(R.id.bottomDialog_custom_view)
        negativeButton = view.findViewById(R.id.bottomDialog_cancel)
        positiveButton = view.findViewById(R.id.bottomDialog_ok)
        ...
        if (builder.btn_positive != null) {
            ...
            positiveButton.setOnClickListener {
                if (builder.btn_positive_callback != null)
                    builder.btn_positive_callback!!.onClick(this@BottomDialog)
        ...
        if (builder.btn_negative != null) {
            ...
            negativeButton.setOnClickListener {
                if (builder.btn_negative_callback != null)
                    builder.btn_negative_callback!!.onClick(this@BottomDialog)
                if (builder.isAutoDismiss)
                    bottomDialog.dismiss()
            }
