...
static const char *FileLoadOperationClassPathName = "ir/amin/HaftTeen/tgnet/FileLoadOperation";
...
static const char *NativeByteBufferClassPathName = "ir/amin/HaftTeen/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "ir/amin/HaftTeen/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(IJLir/amin/HaftTeen/tgnet/RequestDelegateInternal;Lir/amin/HaftTeen/tgnet/QuickAckDelegate;Lir/amin/HaftTeen/tgnet/WriteToSocketDelegate;IIIZI)V", (void *) sendRequest},
        ...
        {"native_checkProxy", "(ILjava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Lir/amin/HaftTeen/tgnet/RequestTimeDelegate;)J", (void *) checkProxy}
};
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("ir/amin/HaftTeen/tgnet/RequestDelegateInternal"));
    ...
    jclass_RequestTimeDelegate = (jclass) env->NewGlobalRef(env->FindClass("ir/amin/HaftTeen/tgnet/RequestTimeDelegate"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("ir/amin/HaftTeen/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_WriteToSocketDelegate = (jclass) env->NewGlobalRef(env->FindClass("ir/amin/HaftTeen/tgnet/WriteToSocketDelegate"));
    ...
    jclass_FileLoadOperationDelegate = (jclass) env->NewGlobalRef(env->FindClass("ir/amin/HaftTeen/tgnet/FileLoadOperationDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("ir/amin/HaftTeen/tgnet/ConnectionsManager"));
...
//
// Copyright Aliaksei Levin (levlam@aan.org), Arseny Smirnov (arseny30@gmail.com) 2014-2018
//
