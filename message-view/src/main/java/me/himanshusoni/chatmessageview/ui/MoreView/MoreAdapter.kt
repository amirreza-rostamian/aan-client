...
import me.himanshusoni.chatmessageview.ui.MoreView.link.*
...
class MoreAdapter : Adapter<MoreViewHolder<Any>>(), MoreLink, AnimExtension, DataAction {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MoreViewHolder<Any> {
        ...
        try {
            ...
            if (moreViewHolder == null) {
                throw ViewHolderInitErrorException(
                        viewHolderClass.simpleName, e.cause?.message
                        ?: ""
                )
            }
        }
    ...
    override fun bindClickListener(holder: MoreViewHolder<*>): MoreClickListener? =
            linkManager.bindClickListener(holder)
