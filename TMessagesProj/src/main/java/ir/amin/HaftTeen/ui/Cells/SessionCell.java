...
public class SessionCell extends FrameLayout {
    ...
    public SessionCell(Context context, int type) {
        ...
        detailTextView.setTypeface(ViewUtil.getFont(context));
        ...
        detailExTextView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 12);
        detailExTextView.setLines(1);
        detailExTextView.setTypeface(ViewUtil.getFont(context));
